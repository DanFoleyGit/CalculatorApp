...
import com.example.calculator.calculator.screen.CalculatorAction
import com.example.calculator.calculator.screen.CalculatorState
...
class CalculatorViewModel : ViewModel() {
    ...
    private fun clearValues() {
        state = state.copy(input = "", result = "", operation = "", number2 = "", number1 = "")
    }
